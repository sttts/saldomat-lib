...
Compression=lzma
OutputDir=.
OutputBaseFilename=gwenhywfar-4.2.1-setup
...
begin
  ...
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_MINOR@', '2');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_PATCHLEVEL@', '1');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_TAG@', 'stable');
