...
AppName=Gwenhywfar
AppVerName=Gwenhywfar 4.12.0beta
...
Compression=lzma
OutputDir=.
OutputBaseFilename=gwenhywfar-4.12.0beta-setup
...
; The plugins
Source: "distribution\usr\lib\gwenhywfar\plugins\60\*"; DestDir: "{app}\lib\gwenhywfar\plugins\60"; Flags: ignoreversion recursesubdirs; Components: main
...
Root: HKLM; Subkey: "Software\Gwenhywfar\Paths"; ValueType: string; ValueName: "plugindir"; ValueData: "{app}\lib\gwenhywfar\plugins\60"
Root: HKLM; Subkey: "Software\Gwenhywfar\Paths"; ValueType: string; ValueName: "dbio-plugins"; ValueData: "{app}\lib\gwenhywfar\plugins\60\dbio"
Root: HKLM; Subkey: "Software\Gwenhywfar\Paths"; ValueType: string; ValueName: "crypttoken-plugins"; ValueData: "{app}\lib\gwenhywfar\plugins\60\crypttoken"
...
begin
  ...
  plugindir := appdir + '/lib/gwenhywfar/plugins/60';
  ...
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_MAJOR@', '4');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_MINOR@', '12');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_PATCHLEVEL@', '0');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_TAG@', 'beta');
