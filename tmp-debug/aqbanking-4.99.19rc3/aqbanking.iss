...
AppName=AqBanking
AppVerName=AqBanking 4.99.19rc3
...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-4.99.19rc3-setup
OutputDir=.
...
begin
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/michael/src/git/lib/static-build-debug-4.99.19rc3/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'AQBANKING_VERSION_PATCHLEVEL@', '19');
  StringChange(FileString, '@'+'AQBANKING_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'AQBANKING_VERSION_TAG@', 'rc3');
  ...
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '19');
