...
AppName=AqBanking
AppVerName=AqBanking 4.99.25rc
...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-4.99.25rc-setup
OutputDir=.
...
begin
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/michael/src/git/lib/static-build-debug-4.99.25rc/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'AQBANKING_VERSION_PATCHLEVEL@', '25');
  StringChange(FileString, '@'+'AQBANKING_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'AQBANKING_VERSION_TAG@', 'rc');
  ...
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '25');
