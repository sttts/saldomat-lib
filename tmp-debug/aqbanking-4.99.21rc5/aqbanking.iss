...
AppName=AqBanking
AppVerName=AqBanking 4.99.21rc5
...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-4.99.21rc5-setup
OutputDir=.
...
begin
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/michael/src/git/lib/static-build-debug-4.99.21rc5/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'AQBANKING_VERSION_PATCHLEVEL@', '21');
  StringChange(FileString, '@'+'AQBANKING_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'AQBANKING_VERSION_TAG@', 'rc5');
  ...
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '21');
