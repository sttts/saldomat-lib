...
AppName=AqBanking
AppVerName=AqBanking 4.99.12beta
...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-4.99.12beta-setup
OutputDir=.
...
begin
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/michael/src/git/lib/static-build-debug-4.99.12beta/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'AQBANKING_VERSION_PATCHLEVEL@', '12');
  ...
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '12');
