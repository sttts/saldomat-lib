...
AppName=Gwenhywfar
AppVerName=Gwenhywfar 3.99.27rc
...
Compression=lzma
OutputDir=.
OutputBaseFilename=gwenhywfar-3.99.27rc-setup
...
begin
  ...
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_PATCHLEVEL@', '27');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_TAG@', 'rc');
