...
AppName=Gwenhywfar
AppVerName=Gwenhywfar 3.99.23rc6
...
Compression=lzma
OutputDir=.
OutputBaseFilename=gwenhywfar-3.99.23rc6-setup
...
begin
  ...
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_PATCHLEVEL@', '23');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_BUILD@', '0');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_TAG@', 'rc6');
