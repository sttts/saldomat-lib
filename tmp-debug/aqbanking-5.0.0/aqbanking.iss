...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-5.0.0-setup
OutputDir=.
...
begin
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/michael/src/git/lib/static-build-debug-5.0.0/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '0');
