...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-5.0.4-setup
OutputDir=.
...
begin
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/michael/src/git/lib/static-build-debug-5.0.4/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '4');
