...
AppName=AqBanking
AppVerName=AqBanking 4.99.7beta
...
LicenseFile=COPYING
OutputBaseFilename=aqbanking-4.99.7beta-setup
OutputDir=.
...
Source: "win32-tmp\gwen\dbio\*"; DestDir: "{reg:HKLM\Software\Gwenhywfar\Paths,dbio-plugins|{app}\lib\aqbanking\plugins\32}"; Flags: ignoreversion recursesubdirs; Components: main
Source: "win32-tmp\gwen\crypttoken\*"; DestDir: "{reg:HKLM\Software\Gwenhywfar\Paths,plugindir|{app}\lib\aqbanking\plugins\32}\crypttoken"; Flags: ignoreversion recursesubdirs; Components: main
...
Root: HKLM; Subkey: "Software\Aqbanking\Paths"; ValueType: string; ValueName: "plugindir"; ValueData: "{app}\lib\aqbanking\plugins\32"; Flags: uninsdeletevalue
Root: HKLM; Subkey: "Software\Aqbanking\Paths"; ValueType: string; ValueName: "providerdir"; ValueData: "{app}\lib\aqbanking\plugins\32\providers"; Flags: uninsdeletevalue
Root: HKLM; Subkey: "Software\Aqbanking\Paths"; ValueType: string; ValueName: "bankinfodir"; ValueData: "{app}\lib\aqbanking\plugins\32\bankinfo"; Flags: uninsdeletevalue
Root: HKLM; Subkey: "Software\Aqbanking\Paths"; ValueType: string; ValueName: "imexporterdir"; ValueData: "{app}\lib\aqbanking\plugins\32\imexporters"; Flags: uninsdeletevalue
Root: HKLM; Subkey: "Software\Aqbanking\Paths"; ValueType: string; ValueName: "importerdir"; ValueData: "{app}\lib\aqbanking\plugins\32\imexporters"; Flags: uninsdeletevalue
...
Root: HKLM; Subkey: "Software\Aqbanking\Paths"; ValueType: string; ValueName: "wizarddir"; ValueData: "{app}\lib\aqbanking\plugins\32\wizards"; Flags: uninsdeletevalue
...
Root: HKLM; Subkey: "Software\AqBanking\Paths"; ValueType: string; ValueName: "cfgmoduledir"; ValueData: "{app}\lib\aqbanking\plugins\32\frontends\qbanking\cfgmodules"; Flags: uninsdeletevalue
...
begin
  ...
  bindir := appdir + '/bin';
  plugindir := appdir + '/lib/aqbanking/plugins/32';
  ...
  StringChange(FileString, '@'+'all_includes@', '-I/Users/sts/Quellen/mac/hbci/lib/static-build-debug-4.99.7beta/include/gwenhywfar4');
  ...
  StringChange(FileString, '@'+'AQBANKING_VERSION_MAJOR@', '4');
  StringChange(FileString, '@'+'AQBANKING_VERSION_MINOR@', '99');
  StringChange(FileString, '@'+'AQBANKING_VERSION_PATCHLEVEL@', '7');
  ...
  StringChange(FileString, '@'+'qbanking_libs@', '-L' + bindir + ' -L${libdir} -lqbanking');
  StringChange(FileString, '@'+'qbanking_includes@', '-I'+includedir);
  StringChange(FileString, '@'+'qbanking_data@', datadir + '/qbanking');
  StringChange(FileString, '@'+'QBANKING_VERSION_MAJOR@', '4');
  StringChange(FileString, '@'+'QBANKING_VERSION_MINOR@', '99');
  StringChange(FileString, '@'+'QBANKING_VERSION_PATCHLEVEL@', '7');
