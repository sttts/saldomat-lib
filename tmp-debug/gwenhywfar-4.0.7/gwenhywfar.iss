...
Compression=lzma
OutputDir=.
OutputBaseFilename=gwenhywfar-4.0.7-setup
...
begin
  ...
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_MINOR@', '0');
  StringChange(FileString, '@'+'GWENHYWFAR_VERSION_PATCHLEVEL@', '7');
