...
typedef enum {
    ...
    INDEX_OPT_VERIFY_CLIENT_CERT   = 12,
    INDEX_OPT_HEARTBEAT            = 13,
    INDEX_OPT_X509FMTDER           = 14,
    INDEX_OPT_PRIORITY             = 15,
    INDEX_OPT_DHPARAMS             = 16,
    ...
    INDEX_OPT_SRPPASSWDCONF        = 30,
    INDEX_OPT_PSKPASSWD            = 31,
    INDEX_OPT_PSKHINT              = 32,
    INDEX_OPT_OCSP_RESPONSE        = 33,
    INDEX_OPT_PORT                 = 34,
    INDEX_OPT_LIST                 = 35,
    INDEX_OPT_PROVIDER             = 36,
...
#define OPTION_CT    40
/** gnutls-serv version */
#define GNUTLS_SERV_VERSION       "3.3.11"
/** Full gnutls-serv version text */
#define GNUTLS_SERV_FULL_VERSION  "gnutls-serv 3.3.11"
...
#define VALUE_OPT_NOTICKET       0x1001
#define VALUE_OPT_GENERATE       'g'
#define VALUE_OPT_QUIET          'q'
#define VALUE_OPT_NODB           0x1002
#define VALUE_OPT_HTTP           0x1003
#define VALUE_OPT_ECHO           0x1004
#define VALUE_OPT_UDP            'u'
#define VALUE_OPT_MTU            0x1005

#define OPT_VALUE_MTU            (DESC(MTU).optArg.argInt)
#define VALUE_OPT_SRTP_PROFILES  0x1006
#define VALUE_OPT_DISABLE_CLIENT_CERT 'a'
#define VALUE_OPT_REQUIRE_CLIENT_CERT 'r'
#define VALUE_OPT_VERIFY_CLIENT_CERT 0x1007
#define VALUE_OPT_HEARTBEAT      'b'
#define VALUE_OPT_X509FMTDER     0x1008
#define VALUE_OPT_PRIORITY       0x1009
#define VALUE_OPT_DHPARAMS       0x100A
#define VALUE_OPT_X509CAFILE     0x100B
#define VALUE_OPT_X509CRLFILE    0x100C
#define VALUE_OPT_PGPKEYFILE     0x100D
#define VALUE_OPT_PGPKEYRING     0x100E
#define VALUE_OPT_PGPCERTFILE    0x100F
...
#define VALUE_OPT_PGPSUBKEY      0x1016
#define VALUE_OPT_SRPPASSWD      0x1017
#define VALUE_OPT_SRPPASSWDCONF  0x1018
#define VALUE_OPT_PSKPASSWD      0x1019
#define VALUE_OPT_PSKHINT        0x101A
#define VALUE_OPT_OCSP_RESPONSE  0x101B
#define VALUE_OPT_PORT           'p'

#define OPT_VALUE_PORT           (DESC(PORT).optArg.argInt)
#define VALUE_OPT_LIST           'l'
#define VALUE_OPT_PROVIDER       0x101C
