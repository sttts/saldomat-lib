...
typedef enum {
    ...
    INDEX_OPT_LOCAL             = 18,
    INDEX_OPT_DOMAIN            = 19,
    INDEX_OPT_LOCAL_DNS         = 20,
    INDEX_OPT_INSECURE          = 21,
    INDEX_OPT_INDER             = 22,
    INDEX_OPT_INRAW             = 23,
    INDEX_OPT_PRINT_RAW         = 24,
    INDEX_OPT_QUIET             = 25,
...
#define OPTION_CT    29
/** danetool version */
#define DANETOOL_VERSION       "3.3.11"
/** Full danetool version text */
#define DANETOOL_FULL_VERSION  "danetool 3.3.11"
...
#define VALUE_OPT_CA             0x100F
#define VALUE_OPT_X509           0x1010
#define VALUE_OPT_LOCAL          0x1011
#define VALUE_OPT_DOMAIN         0x1012
#define VALUE_OPT_LOCAL_DNS      0x1013
#define VALUE_OPT_INSECURE       0x1014
#define VALUE_OPT_INDER          0x1015
#define VALUE_OPT_INRAW          0x1016
#define VALUE_OPT_PRINT_RAW      0x1017
#define VALUE_OPT_QUIET          0x1018
