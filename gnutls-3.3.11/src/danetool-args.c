 ...
 */
static char const danetool_opt_strs[2752] =
/*     0 */ "danetool 3.3.11\n"
            "Copyright (C) 2000-2014 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  1507 */ "PROTO\0"
/*  1513 */ "proto\0"
/*  1519 */ "Specify the port number for the DANE data\0"
/*  1561 */ "PORT\0"
/*  1566 */ "port\0"
...
/*  1662 */ "APP_PROTO\0"
/*  1672 */ "app-proto\0"
/*  1682 */ "Whether the provided certificate or public key is a Certificate\n"
            "Authority\0"
/*  1756 */ "CA\0"
/*  1759 */ "ca\0"
/*  1762 */ "Use the hash of the X.509 certificate, rather than the public key\0"
/*  1828 */ "X509\0"
/*  1833 */ "x509\0"
/*  1838 */ "an alias for the 'domain' option\0"
/*  1871 */ "local\0"
/*  1877 */ "The provided certificate or public key is issued by the local domain\0"
/*  1946 */ "DOMAIN\0"
/*  1953 */ "no-domain\0"
/*  1963 */ "no\0"
/*  1966 */ "Use the local DNS server for DNSSEC resolving\0"
/*  2012 */ "LOCAL_DNS\0"
/*  2022 */ "no-local-dns\0"
/*  2035 */ "Do not verify any DNSSEC signature\0"
/*  2070 */ "INSECURE\0"
/*  2079 */ "insecure\0"
/*  2088 */ "Use DER format for input certificates and private keys\0"
/*  2143 */ "INDER\0"
/*  2149 */ "no-inder\0"
/*  2158 */ "an alias for the 'inder' option\0"
/*  2190 */ "inraw\0"
/*  2196 */ "Print the received DANE data in raw format\0"
/*  2239 */ "PRINT_RAW\0"
/*  2249 */ "no-print-raw\0"
/*  2262 */ "Suppress several informational messages\0"
/*  2302 */ "QUIET\0"
/*  2308 */ "quiet\0"
/*  2314 */ "display extended usage information and exit\0"
/*  2358 */ "help\0"
/*  2363 */ "extended usage information passed thru pager\0"
/*  2408 */ "more-help\0"
/*  2418 */ "output version information and exit\0"
/*  2454 */ "version\0"
/*  2462 */ "DANETOOL\0"
/*  2471 */ "danetool - GnuTLS DANE tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  2557 */ "bugs@gnutls.org\0"
/*  2573 */ "\n\0"
/*  2575 */ "Tool to generate and check DNS resource records for the DANE protocol.\n\0"
/*  2647 */ "danetool 3.3.11\0"
/*  2663 */ "danetool --[tlsa-rr|check] [options]\n"
...
#define PORT_NAME      (danetool_opt_strs+1561)
/** Name string for the port option */
#define PORT_name      (danetool_opt_strs+1566)
...
#define APP_PROTO_DESC      (danetool_opt_strs+1571)
/** Upper-cased name for the app-proto option */
#define APP_PROTO_NAME      (danetool_opt_strs+1662)
/** Name string for the app-proto option */
#define APP_PROTO_name      (danetool_opt_strs+1672)
...
#define CA_DESC      (danetool_opt_strs+1682)
/** Upper-cased name for the ca option */
#define CA_NAME      (danetool_opt_strs+1756)
/** Name string for the ca option */
#define CA_name      (danetool_opt_strs+1759)
...
#define X509_DESC      (danetool_opt_strs+1762)
/** Upper-cased name for the x509 option */
#define X509_NAME      (danetool_opt_strs+1828)
/** Name string for the x509 option */
#define X509_name      (danetool_opt_strs+1833)
...
#define LOCAL_DESC    (danetool_opt_strs+1838)
#define LOCAL_NAME    NULL
/** Unmodified name string for the local option */
#define LOCAL_name    (danetool_opt_strs+1871)
...
#define DOMAIN_DESC      (danetool_opt_strs+1877)
/** Upper-cased name for the domain option */
#define DOMAIN_NAME      (danetool_opt_strs+1946)
/** disablement name for the domain option */
#define NOT_DOMAIN_name  (danetool_opt_strs+1953)
/** disablement prefix for the domain option */
#define NOT_DOMAIN_PFX   (danetool_opt_strs+1963)
...
#define LOCAL_DNS_DESC      (danetool_opt_strs+1966)
/** Upper-cased name for the local-dns option */
#define LOCAL_DNS_NAME      (danetool_opt_strs+2012)
/** disablement name for the local-dns option */
#define NOT_LOCAL_DNS_name  (danetool_opt_strs+2022)
/** disablement prefix for the local-dns option */
#define NOT_LOCAL_DNS_PFX   (danetool_opt_strs+1963)
...
#define INSECURE_DESC      (danetool_opt_strs+2035)
/** Upper-cased name for the insecure option */
#define INSECURE_NAME      (danetool_opt_strs+2070)
/** Name string for the insecure option */
#define INSECURE_name      (danetool_opt_strs+2079)
...
#define INDER_DESC      (danetool_opt_strs+2088)
/** Upper-cased name for the inder option */
#define INDER_NAME      (danetool_opt_strs+2143)
/** disablement name for the inder option */
#define NOT_INDER_name  (danetool_opt_strs+2149)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (danetool_opt_strs+1963)
...
#define INRAW_DESC    (danetool_opt_strs+2158)
#define INRAW_NAME    NULL
/** Unmodified name string for the inraw option */
#define INRAW_name    (danetool_opt_strs+2190)
...
#define PRINT_RAW_DESC      (danetool_opt_strs+2196)
/** Upper-cased name for the print-raw option */
#define PRINT_RAW_NAME      (danetool_opt_strs+2239)
/** disablement name for the print-raw option */
#define NOT_PRINT_RAW_name  (danetool_opt_strs+2249)
/** disablement prefix for the print-raw option */
#define NOT_PRINT_RAW_PFX   (danetool_opt_strs+1963)
...
#define QUIET_DESC      (danetool_opt_strs+2262)
/** Upper-cased name for the quiet option */
#define QUIET_NAME      (danetool_opt_strs+2302)
/** Name string for the quiet option */
#define QUIET_name      (danetool_opt_strs+2308)
 ...
 */
#define HELP_DESC       (danetool_opt_strs+2314)
#define HELP_name       (danetool_opt_strs+2358)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (danetool_opt_strs+2363)
#define MORE_HELP_name  (danetool_opt_strs+2408)
...
#endif
#define VER_DESC        (danetool_opt_strs+2418)
#define VER_name        (danetool_opt_strs+2454)
/**
...
#define zPROGNAME       (danetool_opt_strs+2462)
/** Reference to the title line for danetool usage. */
#define zUsageTitle     (danetool_opt_strs+2471)
...
#define zBugsAddr       (danetool_opt_strs+2557)
/** Clarification/explanation of what danetool does. */
#define zExplain        (danetool_opt_strs+2573)
/** Extra detail explaining what danetool does. */
#define zDetail         (danetool_opt_strs+2575)
/** The full version string for danetool. */
#define zFullVersion    (danetool_opt_strs+2647)
...
#define danetool_short_usage (danetool_opt_strs+2663)
