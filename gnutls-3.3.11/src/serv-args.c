 ...
 */
static char const gnutls_serv_opt_strs[3227] =
/*     0 */ "gnutls-serv 3.3.11\n"
            "Copyright (C) 2000-2014 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
...
/*  1451 */ "If a client certificate is sent then verify it.\0"
/*  1499 */ "VERIFY_CLIENT_CERT\0"
/*  1518 */ "verify-client-cert\0"
/*  1537 */ "Activate heartbeat support\0"
/*  1564 */ "HEARTBEAT\0"
/*  1574 */ "heartbeat\0"
/*  1584 */ "Use DER format for certificates to read from\0"
/*  1629 */ "X509FMTDER\0"
/*  1640 */ "x509fmtder\0"
/*  1651 */ "Priorities string\0"
/*  1669 */ "PRIORITY\0"
/*  1678 */ "priority\0"
/*  1687 */ "DH params file to use\0"
/*  1709 */ "DHPARAMS\0"
/*  1718 */ "dhparams\0"
/*  1727 */ "Certificate file or PKCS #11 URL to use\0"
/*  1767 */ "X509CAFILE\0"
/*  1778 */ "x509cafile\0"
/*  1789 */ "CRL file to use\0"
/*  1805 */ "X509CRLFILE\0"
/*  1817 */ "x509crlfile\0"
/*  1829 */ "PGP Key file to use\0"
/*  1849 */ "PGPKEYFILE\0"
/*  1860 */ "pgpkeyfile\0"
/*  1871 */ "PGP Key ring file to use\0"
/*  1896 */ "PGPKEYRING\0"
/*  1907 */ "pgpkeyring\0"
/*  1918 */ "PGP Public Key (certificate) file to use\0"
/*  1959 */ "PGPCERTFILE\0"
/*  1971 */ "pgpcertfile\0"
/*  1983 */ "X.509 key file or PKCS #11 URL to use\0"
/*  2021 */ "X509KEYFILE\0"
/*  2033 */ "x509keyfile\0"
/*  2045 */ "X.509 Certificate file or PKCS #11 URL to use\0"
/*  2091 */ "X509CERTFILE\0"
/*  2104 */ "x509certfile\0"
/*  2117 */ "Alternative X.509 key file or PKCS #11 URL to use\0"
/*  2167 */ "X509DSAKEYFILE\0"
/*  2182 */ "x509dsakeyfile\0"
/*  2197 */ "Alternative X.509 Certificate file or PKCS #11 URL to use\0"
/*  2255 */ "X509DSACERTFILE\0"
/*  2271 */ "x509dsacertfile\0"
/*  2287 */ "X509ECCKEYFILE\0"
/*  2302 */ "x509ecckeyfile\0"
/*  2317 */ "X509ECCCERTFILE\0"
/*  2333 */ "x509ecccertfile\0"
/*  2349 */ "PGP subkey to use (hex or auto)\0"
/*  2381 */ "PGPSUBKEY\0"
/*  2391 */ "pgpsubkey\0"
/*  2401 */ "SRP password file to use\0"
/*  2426 */ "SRPPASSWD\0"
/*  2436 */ "srppasswd\0"
/*  2446 */ "SRP password configuration file to use\0"
/*  2485 */ "SRPPASSWDCONF\0"
/*  2499 */ "srppasswdconf\0"
/*  2513 */ "PSK password file to use\0"
/*  2538 */ "PSKPASSWD\0"
/*  2548 */ "pskpasswd\0"
/*  2558 */ "PSK identity hint to use\0"
/*  2583 */ "PSKHINT\0"
/*  2591 */ "pskhint\0"
/*  2599 */ "The OCSP response to send to client\0"
/*  2635 */ "OCSP_RESPONSE\0"
/*  2649 */ "ocsp-response\0"
/*  2663 */ "The port to connect to\0"
/*  2686 */ "PORT\0"
/*  2691 */ "port\0"
/*  2696 */ "Print a list of the supported algorithms and modes\0"
/*  2747 */ "LIST\0"
/*  2752 */ "list\0"
/*  2757 */ "Specify the PKCS #11 provider library\0"
/*  2795 */ "PROVIDER\0"
/*  2804 */ "provider\0"
/*  2813 */ "display extended usage information and exit\0"
/*  2857 */ "help\0"
/*  2862 */ "extended usage information passed thru pager\0"
/*  2907 */ "more-help\0"
/*  2917 */ "output version information and exit\0"
/*  2953 */ "version\0"
/*  2961 */ "GNUTLS_SERV\0"
/*  2973 */ "gnutls-serv - GnuTLS server\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  3059 */ "bugs@gnutls.org\0"
/*  3075 */ "\n\0"
/*  3077 */ "Server program that listens to incoming TLS connections.\n\0"
/*  3135 */ "gnutls-serv 3.3.11\0"
/*  3154 */ "Usage: gnutls-serv [options]\n"
...
#define VERIFY_CLIENT_CERT_DESC      (gnutls_serv_opt_strs+1451)
/** Upper-cased name for the verify-client-cert option */
#define VERIFY_CLIENT_CERT_NAME      (gnutls_serv_opt_strs+1499)
/** Name string for the verify-client-cert option */
#define VERIFY_CLIENT_CERT_name      (gnutls_serv_opt_strs+1518)
...
#define HEARTBEAT_DESC      (gnutls_serv_opt_strs+1537)
/** Upper-cased name for the heartbeat option */
#define HEARTBEAT_NAME      (gnutls_serv_opt_strs+1564)
/** Name string for the heartbeat option */
#define HEARTBEAT_name      (gnutls_serv_opt_strs+1574)
...
#define X509FMTDER_DESC      (gnutls_serv_opt_strs+1584)
/** Upper-cased name for the x509fmtder option */
#define X509FMTDER_NAME      (gnutls_serv_opt_strs+1629)
/** Name string for the x509fmtder option */
#define X509FMTDER_name      (gnutls_serv_opt_strs+1640)
...
#define PRIORITY_DESC      (gnutls_serv_opt_strs+1651)
/** Upper-cased name for the priority option */
#define PRIORITY_NAME      (gnutls_serv_opt_strs+1669)
/** Name string for the priority option */
#define PRIORITY_name      (gnutls_serv_opt_strs+1678)
...
#define DHPARAMS_DESC      (gnutls_serv_opt_strs+1687)
/** Upper-cased name for the dhparams option */
#define DHPARAMS_NAME      (gnutls_serv_opt_strs+1709)
/** Name string for the dhparams option */
#define DHPARAMS_name      (gnutls_serv_opt_strs+1718)
...
#define X509CAFILE_DESC      (gnutls_serv_opt_strs+1727)
/** Upper-cased name for the x509cafile option */
#define X509CAFILE_NAME      (gnutls_serv_opt_strs+1767)
/** Name string for the x509cafile option */
#define X509CAFILE_name      (gnutls_serv_opt_strs+1778)
...
#define X509CRLFILE_DESC      (gnutls_serv_opt_strs+1789)
/** Upper-cased name for the x509crlfile option */
#define X509CRLFILE_NAME      (gnutls_serv_opt_strs+1805)
/** Name string for the x509crlfile option */
#define X509CRLFILE_name      (gnutls_serv_opt_strs+1817)
...
#define PGPKEYFILE_DESC      (gnutls_serv_opt_strs+1829)
/** Upper-cased name for the pgpkeyfile option */
#define PGPKEYFILE_NAME      (gnutls_serv_opt_strs+1849)
/** Name string for the pgpkeyfile option */
#define PGPKEYFILE_name      (gnutls_serv_opt_strs+1860)
...
#define PGPKEYRING_DESC      (gnutls_serv_opt_strs+1871)
/** Upper-cased name for the pgpkeyring option */
#define PGPKEYRING_NAME      (gnutls_serv_opt_strs+1896)
/** Name string for the pgpkeyring option */
#define PGPKEYRING_name      (gnutls_serv_opt_strs+1907)
...
#define PGPCERTFILE_DESC      (gnutls_serv_opt_strs+1918)
/** Upper-cased name for the pgpcertfile option */
#define PGPCERTFILE_NAME      (gnutls_serv_opt_strs+1959)
/** Name string for the pgpcertfile option */
#define PGPCERTFILE_name      (gnutls_serv_opt_strs+1971)
...
#define X509KEYFILE_DESC      (gnutls_serv_opt_strs+1983)
/** Upper-cased name for the x509keyfile option */
#define X509KEYFILE_NAME      (gnutls_serv_opt_strs+2021)
/** Name string for the x509keyfile option */
#define X509KEYFILE_name      (gnutls_serv_opt_strs+2033)
...
#define X509CERTFILE_DESC      (gnutls_serv_opt_strs+2045)
/** Upper-cased name for the x509certfile option */
#define X509CERTFILE_NAME      (gnutls_serv_opt_strs+2091)
/** Name string for the x509certfile option */
#define X509CERTFILE_name      (gnutls_serv_opt_strs+2104)
...
#define X509DSAKEYFILE_DESC      (gnutls_serv_opt_strs+2117)
/** Upper-cased name for the x509dsakeyfile option */
#define X509DSAKEYFILE_NAME      (gnutls_serv_opt_strs+2167)
/** Name string for the x509dsakeyfile option */
#define X509DSAKEYFILE_name      (gnutls_serv_opt_strs+2182)
...
#define X509DSACERTFILE_DESC      (gnutls_serv_opt_strs+2197)
/** Upper-cased name for the x509dsacertfile option */
#define X509DSACERTFILE_NAME      (gnutls_serv_opt_strs+2255)
/** Name string for the x509dsacertfile option */
#define X509DSACERTFILE_name      (gnutls_serv_opt_strs+2271)
...
#define X509ECCKEYFILE_DESC      (gnutls_serv_opt_strs+2117)
/** Upper-cased name for the x509ecckeyfile option */
#define X509ECCKEYFILE_NAME      (gnutls_serv_opt_strs+2287)
/** Name string for the x509ecckeyfile option */
#define X509ECCKEYFILE_name      (gnutls_serv_opt_strs+2302)
...
#define X509ECCCERTFILE_DESC      (gnutls_serv_opt_strs+2197)
/** Upper-cased name for the x509ecccertfile option */
#define X509ECCCERTFILE_NAME      (gnutls_serv_opt_strs+2317)
/** Name string for the x509ecccertfile option */
#define X509ECCCERTFILE_name      (gnutls_serv_opt_strs+2333)
...
#define PGPSUBKEY_DESC      (gnutls_serv_opt_strs+2349)
/** Upper-cased name for the pgpsubkey option */
#define PGPSUBKEY_NAME      (gnutls_serv_opt_strs+2381)
/** Name string for the pgpsubkey option */
#define PGPSUBKEY_name      (gnutls_serv_opt_strs+2391)
...
#define SRPPASSWD_DESC      (gnutls_serv_opt_strs+2401)
/** Upper-cased name for the srppasswd option */
#define SRPPASSWD_NAME      (gnutls_serv_opt_strs+2426)
/** Name string for the srppasswd option */
#define SRPPASSWD_name      (gnutls_serv_opt_strs+2436)
...
#define SRPPASSWDCONF_DESC      (gnutls_serv_opt_strs+2446)
/** Upper-cased name for the srppasswdconf option */
#define SRPPASSWDCONF_NAME      (gnutls_serv_opt_strs+2485)
/** Name string for the srppasswdconf option */
#define SRPPASSWDCONF_name      (gnutls_serv_opt_strs+2499)
...
#define PSKPASSWD_DESC      (gnutls_serv_opt_strs+2513)
/** Upper-cased name for the pskpasswd option */
#define PSKPASSWD_NAME      (gnutls_serv_opt_strs+2538)
/** Name string for the pskpasswd option */
#define PSKPASSWD_name      (gnutls_serv_opt_strs+2548)
...
#define PSKHINT_DESC      (gnutls_serv_opt_strs+2558)
/** Upper-cased name for the pskhint option */
#define PSKHINT_NAME      (gnutls_serv_opt_strs+2583)
/** Name string for the pskhint option */
#define PSKHINT_name      (gnutls_serv_opt_strs+2591)
...
#define OCSP_RESPONSE_DESC      (gnutls_serv_opt_strs+2599)
/** Upper-cased name for the ocsp-response option */
#define OCSP_RESPONSE_NAME      (gnutls_serv_opt_strs+2635)
/** Name string for the ocsp-response option */
#define OCSP_RESPONSE_name      (gnutls_serv_opt_strs+2649)
...
#define PORT_DESC      (gnutls_serv_opt_strs+2663)
/** Upper-cased name for the port option */
#define PORT_NAME      (gnutls_serv_opt_strs+2686)
/** Name string for the port option */
#define PORT_name      (gnutls_serv_opt_strs+2691)
...
#define LIST_DESC      (gnutls_serv_opt_strs+2696)
/** Upper-cased name for the list option */
#define LIST_NAME      (gnutls_serv_opt_strs+2747)
/** Name string for the list option */
#define LIST_name      (gnutls_serv_opt_strs+2752)
...
#define PROVIDER_DESC      (gnutls_serv_opt_strs+2757)
/** Upper-cased name for the provider option */
#define PROVIDER_NAME      (gnutls_serv_opt_strs+2795)
/** Name string for the provider option */
#define PROVIDER_name      (gnutls_serv_opt_strs+2804)
 ...
 */
#define HELP_DESC       (gnutls_serv_opt_strs+2813)
#define HELP_name       (gnutls_serv_opt_strs+2857)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (gnutls_serv_opt_strs+2862)
#define MORE_HELP_name  (gnutls_serv_opt_strs+2907)
...
#endif
#define VER_DESC        (gnutls_serv_opt_strs+2917)
#define VER_name        (gnutls_serv_opt_strs+2953)
/**
...
#define zPROGNAME       (gnutls_serv_opt_strs+2961)
/** Reference to the title line for gnutls-serv usage. */
#define zUsageTitle     (gnutls_serv_opt_strs+2973)
...
#define zBugsAddr       (gnutls_serv_opt_strs+3059)
/** Clarification/explanation of what gnutls-serv does. */
#define zExplain        (gnutls_serv_opt_strs+3075)
/** Extra detail explaining what gnutls-serv does. */
#define zDetail         (gnutls_serv_opt_strs+3077)
/** The full version string for gnutls-serv. */
#define zFullVersion    (gnutls_serv_opt_strs+3135)
...
#define gnutls_serv_short_usage (gnutls_serv_opt_strs+3154)
