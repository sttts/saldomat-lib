...
#define OPTION_CT    19
/** tpmtool version */
#define TPMTOOL_VERSION       "3.3.11"
/** Full tpmtool version text */
#define TPMTOOL_FULL_VERSION  "tpmtool 3.3.11"
...
#define VALUE_OPT_SEC_PARAM      0x100C
#define VALUE_OPT_BITS           0x100D

#define OPT_VALUE_BITS           (DESC(BITS).optArg.argInt)
#define VALUE_OPT_INDER          0x100E
#define VALUE_OPT_OUTDER         0x100F
