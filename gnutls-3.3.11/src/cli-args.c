 ...
 */
static char const gnutls_cli_opt_strs[4286] =
/*     0 */ "gnutls-cli 3.3.11\n"
            "Copyright (C) 2000-2014 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  2784 */ "Benchmark TLS key exchange methods\0"
/*  2819 */ "BENCHMARK_TLS_KX\0"
/*  2836 */ "benchmark-tls-kx\0"
/*  2853 */ "Benchmark TLS ciphers\0"
/*  2875 */ "BENCHMARK_TLS_CIPHERS\0"
/*  2897 */ "benchmark-tls-ciphers\0"
/*  2919 */ "Print a list of the supported algorithms and modes\0"
/*  2970 */ "LIST\0"
/*  2975 */ "list\0"
/*  2980 */ "Don't allow session tickets\0"
/*  3008 */ "NOTICKET\0"
/*  3017 */ "noticket\0"
/*  3026 */ "Offer SRTP profiles\0"
/*  3046 */ "SRTP_PROFILES\0"
/*  3060 */ "srtp-profiles\0"
/*  3074 */ "Application layer protocol\0"
/*  3101 */ "ALPN\0"
/*  3106 */ "alpn\0"
/*  3111 */ "Activate heartbeat support\0"
/*  3138 */ "HEARTBEAT\0"
/*  3148 */ "heartbeat\0"
/*  3158 */ "The maximum record size to advertize\0"
/*  3195 */ "RECORDSIZE\0"
/*  3206 */ "recordsize\0"
/*  3217 */ "Do not send a Server Name Indication (SNI)\0"
/*  3260 */ "DISABLE_SNI\0"
/*  3272 */ "disable-sni\0"
/*  3284 */ "Disable all the TLS extensions\0"
/*  3315 */ "DISABLE_EXTENSIONS\0"
/*  3334 */ "disable-extensions\0"
/*  3353 */ "Inline commands of the form ^<cmd>^\0"
/*  3389 */ "INLINE_COMMANDS\0"
/*  3405 */ "inline-commands\0"
/*  3421 */ "Change the default (^) used as a delimiter for inline commands.  The\n"
            "value is a single US-ASCII character (octets 0 - 127).\0"
/*  3545 */ "INLINE_COMMANDS_PREFIX\0"
/*  3568 */ "inline-commands-prefix\0"
/*  3591 */ "Specify the PKCS #11 provider library\0"
/*  3629 */ "PROVIDER\0"
/*  3638 */ "provider\0"
/*  3647 */ "Reports the status of the FIPS140-2 mode in gnutls library\0"
/*  3706 */ "FIPS140_MODE\0"
/*  3719 */ "fips140-mode\0"
/*  3732 */ "display extended usage information and exit\0"
/*  3776 */ "help\0"
/*  3781 */ "extended usage information passed thru pager\0"
/*  3826 */ "more-help\0"
/*  3836 */ "output version information and exit\0"
/*  3872 */ "version\0"
/*  3880 */ "GNUTLS_CLI\0"
/*  3891 */ "gnutls-cli - GnuTLS client\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [hostname]\n\0"
/*  3987 */ "bugs@gnutls.org\0"
/*  4003 */ "\n\0"
/*  4005 */ "Simple client program to set up a TLS connection to some other computer.  It\n"
            "sets up a TLS connection and forwards data from the standard input to the\n"
            "secured socket and vice versa.\n\0"
/*  4188 */ "gnutls-cli 3.3.11\0"
/*  4206 */ "Usage: gnutls-cli [options] hostname\n"
...
#define BENCHMARK_TLS_KX_DESC      (gnutls_cli_opt_strs+2784)
/** Upper-cased name for the benchmark-tls-kx option */
#define BENCHMARK_TLS_KX_NAME      (gnutls_cli_opt_strs+2819)
/** Name string for the benchmark-tls-kx option */
#define BENCHMARK_TLS_KX_name      (gnutls_cli_opt_strs+2836)
...
#define BENCHMARK_TLS_CIPHERS_DESC      (gnutls_cli_opt_strs+2853)
/** Upper-cased name for the benchmark-tls-ciphers option */
#define BENCHMARK_TLS_CIPHERS_NAME      (gnutls_cli_opt_strs+2875)
/** Name string for the benchmark-tls-ciphers option */
#define BENCHMARK_TLS_CIPHERS_name      (gnutls_cli_opt_strs+2897)
...
#define LIST_DESC      (gnutls_cli_opt_strs+2919)
/** Upper-cased name for the list option */
#define LIST_NAME      (gnutls_cli_opt_strs+2970)
/** Name string for the list option */
#define LIST_name      (gnutls_cli_opt_strs+2975)
...
#define NOTICKET_DESC      (gnutls_cli_opt_strs+2980)
/** Upper-cased name for the noticket option */
#define NOTICKET_NAME      (gnutls_cli_opt_strs+3008)
/** Name string for the noticket option */
#define NOTICKET_name      (gnutls_cli_opt_strs+3017)
...
#define SRTP_PROFILES_DESC      (gnutls_cli_opt_strs+3026)
/** Upper-cased name for the srtp_profiles option */
#define SRTP_PROFILES_NAME      (gnutls_cli_opt_strs+3046)
/** Name string for the srtp_profiles option */
#define SRTP_PROFILES_name      (gnutls_cli_opt_strs+3060)
...
#define ALPN_DESC      (gnutls_cli_opt_strs+3074)
/** Upper-cased name for the alpn option */
#define ALPN_NAME      (gnutls_cli_opt_strs+3101)
/** Name string for the alpn option */
#define ALPN_name      (gnutls_cli_opt_strs+3106)
...
#define HEARTBEAT_DESC      (gnutls_cli_opt_strs+3111)
/** Upper-cased name for the heartbeat option */
#define HEARTBEAT_NAME      (gnutls_cli_opt_strs+3138)
/** Name string for the heartbeat option */
#define HEARTBEAT_name      (gnutls_cli_opt_strs+3148)
...
#define RECORDSIZE_DESC      (gnutls_cli_opt_strs+3158)
/** Upper-cased name for the recordsize option */
#define RECORDSIZE_NAME      (gnutls_cli_opt_strs+3195)
/** Name string for the recordsize option */
#define RECORDSIZE_name      (gnutls_cli_opt_strs+3206)
...
#define DISABLE_SNI_DESC      (gnutls_cli_opt_strs+3217)
/** Upper-cased name for the disable-sni option */
#define DISABLE_SNI_NAME      (gnutls_cli_opt_strs+3260)
/** Name string for the disable-sni option */
#define DISABLE_SNI_name      (gnutls_cli_opt_strs+3272)
...
#define DISABLE_EXTENSIONS_DESC      (gnutls_cli_opt_strs+3284)
/** Upper-cased name for the disable-extensions option */
#define DISABLE_EXTENSIONS_NAME      (gnutls_cli_opt_strs+3315)
/** Name string for the disable-extensions option */
#define DISABLE_EXTENSIONS_name      (gnutls_cli_opt_strs+3334)
...
#define INLINE_COMMANDS_DESC      (gnutls_cli_opt_strs+3353)
/** Upper-cased name for the inline-commands option */
#define INLINE_COMMANDS_NAME      (gnutls_cli_opt_strs+3389)
/** Name string for the inline-commands option */
#define INLINE_COMMANDS_name      (gnutls_cli_opt_strs+3405)
...
#define INLINE_COMMANDS_PREFIX_DESC      (gnutls_cli_opt_strs+3421)
/** Upper-cased name for the inline-commands-prefix option */
#define INLINE_COMMANDS_PREFIX_NAME      (gnutls_cli_opt_strs+3545)
/** Name string for the inline-commands-prefix option */
#define INLINE_COMMANDS_PREFIX_name      (gnutls_cli_opt_strs+3568)
...
#define PROVIDER_DESC      (gnutls_cli_opt_strs+3591)
/** Upper-cased name for the provider option */
#define PROVIDER_NAME      (gnutls_cli_opt_strs+3629)
/** Name string for the provider option */
#define PROVIDER_name      (gnutls_cli_opt_strs+3638)
...
#define FIPS140_MODE_DESC      (gnutls_cli_opt_strs+3647)
/** Upper-cased name for the fips140-mode option */
#define FIPS140_MODE_NAME      (gnutls_cli_opt_strs+3706)
/** Name string for the fips140-mode option */
#define FIPS140_MODE_name      (gnutls_cli_opt_strs+3719)
 ...
 */
#define HELP_DESC       (gnutls_cli_opt_strs+3732)
#define HELP_name       (gnutls_cli_opt_strs+3776)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (gnutls_cli_opt_strs+3781)
#define MORE_HELP_name  (gnutls_cli_opt_strs+3826)
...
#endif
#define VER_DESC        (gnutls_cli_opt_strs+3836)
#define VER_name        (gnutls_cli_opt_strs+3872)
/**
...
#define zPROGNAME       (gnutls_cli_opt_strs+3880)
/** Reference to the title line for gnutls-cli usage. */
#define zUsageTitle     (gnutls_cli_opt_strs+3891)
...
#define zBugsAddr       (gnutls_cli_opt_strs+3987)
/** Clarification/explanation of what gnutls-cli does. */
#define zExplain        (gnutls_cli_opt_strs+4003)
/** Extra detail explaining what gnutls-cli does. */
#define zDetail         (gnutls_cli_opt_strs+4005)
/** The full version string for gnutls-cli. */
#define zFullVersion    (gnutls_cli_opt_strs+4188)
...
#define gnutls_cli_short_usage (gnutls_cli_opt_strs+4206)
