...
typedef enum {
    ...
    INDEX_OPT_INFO               =  6,
    INDEX_OPT_LIST_ALL           =  7,
    INDEX_OPT_LIST_ALL_CERTS     =  8,
    INDEX_OPT_LIST_CERTS         =  9,
    INDEX_OPT_LIST_ALL_PRIVKEYS  = 10,
    INDEX_OPT_LIST_PRIVKEYS      = 11,
    INDEX_OPT_LIST_KEYS          = 12,
    INDEX_OPT_LIST_ALL_TRUSTED   = 13,
    INDEX_OPT_WRITE              = 14,
    INDEX_OPT_DELETE             = 15,
    ...
    INDEX_OPT_LABEL              = 21,
    INDEX_OPT_MARK_WRAP          = 22,
    INDEX_OPT_MARK_TRUSTED       = 23,
    INDEX_OPT_MARK_CA            = 24,
    INDEX_OPT_MARK_PRIVATE       = 25,
    INDEX_OPT_TRUSTED            = 26,
    INDEX_OPT_CA                 = 27,
    INDEX_OPT_PRIVATE            = 28,
    INDEX_OPT_LOGIN              = 29,
    INDEX_OPT_SO_LOGIN           = 30,
    INDEX_OPT_ADMIN_LOGIN        = 31,
    INDEX_OPT_DETAILED_URL       = 32,
    INDEX_OPT_SECRET_KEY         = 33,
    INDEX_OPT_LOAD_PRIVKEY       = 34,
    INDEX_OPT_LOAD_PUBKEY        = 35,
    INDEX_OPT_LOAD_CERTIFICATE   = 36,
    INDEX_OPT_PKCS8              = 37,
    INDEX_OPT_BITS               = 38,
    INDEX_OPT_CURVE              = 39,
    INDEX_OPT_SEC_PARAM          = 40,
    INDEX_OPT_INDER              = 41,
    INDEX_OPT_INRAW              = 42,
    INDEX_OPT_OUTDER             = 43,
    INDEX_OPT_OUTRAW             = 44,
    INDEX_OPT_INITIALIZE         = 45,
    INDEX_OPT_SET_PIN            = 46,
    INDEX_OPT_SET_SO_PIN         = 47,
    INDEX_OPT_PROVIDER           = 48,
    INDEX_OPT_BATCH              = 49,
    INDEX_OPT_VERSION            = 50,
    INDEX_OPT_HELP               = 51,
    INDEX_OPT_MORE_HELP          = 52
} teOptIndex;
/** count of all options for p11tool */
#define OPTION_CT    53
/** p11tool version */
#define P11TOOL_VERSION       "3.3.11"
/** Full p11tool version text */
#define P11TOOL_FULL_VERSION  "p11tool 3.3.11"
...
#define VALUE_OPT_INFO           0x1006
#define VALUE_OPT_LIST_ALL       0x1007
#define VALUE_OPT_LIST_ALL_CERTS 0x1008
#define VALUE_OPT_LIST_CERTS     0x1009
#define VALUE_OPT_LIST_ALL_PRIVKEYS 0x100A
#define VALUE_OPT_LIST_PRIVKEYS  0x100B
#define VALUE_OPT_LIST_KEYS      0x100C
#define VALUE_OPT_LIST_ALL_TRUSTED 0x100D
...
#define VALUE_OPT_EXPORT_PUBKEY  0x1014
#define VALUE_OPT_LABEL          0x1015
#define VALUE_OPT_MARK_WRAP      0x1016
#define VALUE_OPT_MARK_TRUSTED   0x1017
#define VALUE_OPT_MARK_CA        0x1018
#define VALUE_OPT_MARK_PRIVATE   0x1019
#define VALUE_OPT_TRUSTED        0x101A
#define VALUE_OPT_CA             0x101B
#define VALUE_OPT_PRIVATE        0x101C
#define VALUE_OPT_LOGIN          0x101D
#define VALUE_OPT_SO_LOGIN       0x101E
#define VALUE_OPT_ADMIN_LOGIN    0x101F
#define VALUE_OPT_DETAILED_URL   0x1020
#define VALUE_OPT_SECRET_KEY     0x1021
#define VALUE_OPT_LOAD_PRIVKEY   0x1022
#define VALUE_OPT_LOAD_PUBKEY    0x1023
#define VALUE_OPT_LOAD_CERTIFICATE 0x1024
#define VALUE_OPT_PKCS8          '8'
#define VALUE_OPT_BITS           0x1025

#define OPT_VALUE_BITS           (DESC(BITS).optArg.argInt)
#define VALUE_OPT_CURVE          0x1026
#define VALUE_OPT_SEC_PARAM      0x1027
#define VALUE_OPT_INDER          0x1028
#define VALUE_OPT_INRAW          0x1029
#define VALUE_OPT_OUTDER         0x102A
#define VALUE_OPT_OUTRAW         0x102B
#define VALUE_OPT_INITIALIZE     0x102C
#define VALUE_OPT_SET_PIN        0x102D
#define VALUE_OPT_SET_SO_PIN     0x102E
#define VALUE_OPT_PROVIDER       0x102F
#define VALUE_OPT_BATCH          0x1030
