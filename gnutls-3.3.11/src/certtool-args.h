...
typedef enum {
    ...
    INDEX_OPT_EMPTY_PASSWORD        = 25,
    INDEX_OPT_HEX_NUMBERS           = 26,
    INDEX_OPT_CPRINT                = 27,
    INDEX_OPT_CERTIFICATE_INFO      = 28,
    INDEX_OPT_CERTIFICATE_PUBKEY    = 29,
    INDEX_OPT_PGP_CERTIFICATE_INFO  = 30,
    INDEX_OPT_PGP_RING_INFO         = 31,
    INDEX_OPT_CRL_INFO              = 32,
    INDEX_OPT_CRQ_INFO              = 33,
    INDEX_OPT_NO_CRQ_EXTENSIONS     = 34,
    INDEX_OPT_P12_INFO              = 35,
    INDEX_OPT_P12_NAME              = 36,
    INDEX_OPT_P7_INFO               = 37,
    INDEX_OPT_SMIME_TO_P7           = 38,
    INDEX_OPT_KEY_INFO              = 39,
    INDEX_OPT_PGP_KEY_INFO          = 40,
    INDEX_OPT_PUBKEY_INFO           = 41,
    INDEX_OPT_V1                    = 42,
    INDEX_OPT_TO_P12                = 43,
    INDEX_OPT_TO_P8                 = 44,
    INDEX_OPT_PKCS8                 = 45,
    ...
    INDEX_OPT_BITS                  = 55,
    INDEX_OPT_CURVE                 = 56,
    INDEX_OPT_SEC_PARAM             = 57,
    INDEX_OPT_DISABLE_QUICK_RANDOM  = 58,
    INDEX_OPT_TEMPLATE              = 59,
    INDEX_OPT_STDOUT_INFO           = 60,
    INDEX_OPT_ASK_PASS              = 61,
    INDEX_OPT_PKCS_CIPHER           = 62,
    INDEX_OPT_PROVIDER              = 63,
...
#define OPTION_CT    67
/** certtool version */
#define CERTTOOL_VERSION       "3.3.11"
/** Full certtool version text */
#define CERTTOOL_FULL_VERSION  "certtool 3.3.11"
...
#define VALUE_OPT_VERIFY         0x1005
#define VALUE_OPT_VERIFY_CRL     0x1006
#define VALUE_OPT_GENERATE_DH_PARAMS 0x1007
#define VALUE_OPT_GET_DH_PARAMS  0x1008
#define VALUE_OPT_DH_INFO        0x1009
#define VALUE_OPT_LOAD_PRIVKEY   0x100A
#define VALUE_OPT_LOAD_PUBKEY    0x100B
#define VALUE_OPT_LOAD_REQUEST   0x100C
#define VALUE_OPT_LOAD_CERTIFICATE 0x100D
#define VALUE_OPT_LOAD_CA_PRIVKEY 0x100E
#define VALUE_OPT_LOAD_CA_CERTIFICATE 0x100F
#define VALUE_OPT_PASSWORD       0x1010
#define VALUE_OPT_NULL_PASSWORD  0x1011
#define VALUE_OPT_EMPTY_PASSWORD 0x1012
#define VALUE_OPT_HEX_NUMBERS    0x1013
#define VALUE_OPT_CPRINT         0x1014
#define VALUE_OPT_CERTIFICATE_INFO 'i'
#define VALUE_OPT_CERTIFICATE_PUBKEY 0x1015
#define VALUE_OPT_PGP_CERTIFICATE_INFO 0x1016
#define VALUE_OPT_PGP_RING_INFO  0x1017
#define VALUE_OPT_CRL_INFO       'l'
#define VALUE_OPT_CRQ_INFO       0x1018
#define VALUE_OPT_NO_CRQ_EXTENSIONS 0x1019
#define VALUE_OPT_P12_INFO       0x101A
#define VALUE_OPT_P12_NAME       0x101B
#define VALUE_OPT_P7_INFO        0x101C
#define VALUE_OPT_SMIME_TO_P7    0x101D
#define VALUE_OPT_KEY_INFO       'k'
#define VALUE_OPT_PGP_KEY_INFO   0x101E
#define VALUE_OPT_PUBKEY_INFO    0x101F
#define VALUE_OPT_V1             0x1020
#define VALUE_OPT_TO_P12         0x1021
#define VALUE_OPT_TO_P8          0x1022
#define VALUE_OPT_PKCS8          '8'
#define VALUE_OPT_RSA            0x1023
#define VALUE_OPT_DSA            0x1024
#define VALUE_OPT_ECC            0x1025
#define VALUE_OPT_ECDSA          0x1026
#define VALUE_OPT_HASH           0x1027
#define VALUE_OPT_INDER          0x1028
#define VALUE_OPT_INRAW          0x1029
#define VALUE_OPT_OUTDER         0x102A
#define VALUE_OPT_OUTRAW         0x102B
#define VALUE_OPT_BITS           0x102C

#define OPT_VALUE_BITS           (DESC(BITS).optArg.argInt)
#define VALUE_OPT_CURVE          0x102D
#define VALUE_OPT_SEC_PARAM      0x102E
#define VALUE_OPT_DISABLE_QUICK_RANDOM 0x102F
#define VALUE_OPT_TEMPLATE       0x1030
#define VALUE_OPT_STDOUT_INFO    0x1031
#define VALUE_OPT_ASK_PASS       0x1032
#define VALUE_OPT_PKCS_CIPHER    0x1033
#define VALUE_OPT_PROVIDER       0x1034
