...
typedef enum {
    ...
    INDEX_OPT_PROVIDER                = 47,
    INDEX_OPT_FIPS140_MODE            = 48,
...
#define OPTION_CT    52
/** gnutls-cli version */
#define GNUTLS_CLI_VERSION       "3.3.11"
/** Full gnutls-cli version text */
#define GNUTLS_CLI_FULL_VERSION  "gnutls-cli 3.3.11"
...
#define VALUE_OPT_CRLF           0x1008
#define VALUE_OPT_X509FMTDER     0x1009
#define VALUE_OPT_FINGERPRINT    'f'
#define VALUE_OPT_PRINT_CERT     0x100A
#define VALUE_OPT_DH_BITS        0x100B

#define OPT_VALUE_DH_BITS        (DESC(DH_BITS).optArg.argInt)
#define VALUE_OPT_PRIORITY       0x100C
...
#define VALUE_OPT_PGPSUBKEY      0x1014
#define VALUE_OPT_SRPUSERNAME    0x1015
#define VALUE_OPT_SRPPASSWD      0x1016
#define VALUE_OPT_PSKUSERNAME    0x1017
#define VALUE_OPT_PSKKEY         0x1018
#define VALUE_OPT_PORT           'p'
#define VALUE_OPT_INSECURE       0x1019
#define VALUE_OPT_RANGES         0x101A
#define VALUE_OPT_BENCHMARK_CIPHERS 0x101B
#define VALUE_OPT_BENCHMARK_TLS_KX 0x101C
#define VALUE_OPT_BENCHMARK_TLS_CIPHERS 0x101D
#define VALUE_OPT_LIST           'l'
#define VALUE_OPT_NOTICKET       0x101E
#define VALUE_OPT_SRTP_PROFILES  0x101F
#define VALUE_OPT_ALPN           0x1020
#define VALUE_OPT_HEARTBEAT      'b'
#define VALUE_OPT_RECORDSIZE     0x1021

#define OPT_VALUE_RECORDSIZE     (DESC(RECORDSIZE).optArg.argInt)
#define VALUE_OPT_DISABLE_SNI    0x1022
#define VALUE_OPT_DISABLE_EXTENSIONS 0x1023
#define VALUE_OPT_INLINE_COMMANDS 0x1024
#define VALUE_OPT_INLINE_COMMANDS_PREFIX 0x1025
#define VALUE_OPT_PROVIDER       0x1026
#define VALUE_OPT_FIPS140_MODE   0x1027
